...
<html>
	...
	<div id="topheader">
		<h1 id="title">
			<a href="#">欢迎${user.username}来到“快捷交友”平台</a>
		</h1>
	</div>
	<div id="navigation">
	</div>
				...
				<div id="content">
					...
					<h1>
						<img src="img/sx.gif"/><a id="sx" href="javascript:;" onclick="sx();">收信箱</a>
					</h1>
					<h1>
						<img src="img/lwx.gif"/><a id="lw" href="javascript:;" onclick="lw();">礼物箱</a>
					</h1>
					<h1>
						已有用户
					</h1>
